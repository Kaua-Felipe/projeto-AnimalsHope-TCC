...
function buscaCidades(e){
  ...
  if(e != ''){
      ...
      if(j_index != -1){
        ...
        cidade_select.removeAttribute('disabled');
        json_cidades.estados[j_index].cidades.forEach(function(cidade){
            var cid_opts = document.createElement('option');
            cid_opts.setAttribute('value',cidade)
            if(cid_opts.value == document.getElementById('pre-cidade').value){
                  cid_opts.setAttribute("selected","selected");
            }
            cid_opts.innerHTML = cidade;
            cidade_select.appendChild(cid_opts);

            var opt_neutro = document.createElement('option');
            opt_neutro.setAttribute('value', "")
            opt_neutro.innerHTML = "Nenhuma Cidade"
        });
      }else{
        document.querySelector("#cidade").innerHTML = '';
        cid_opts = document.createElement('option');
        cid_opts.setAttribute('value', '');
        cid_opts.innerHTML = "Cidade";
      }
  }else{
      cidade_select.setAttribute('disabled', true);
      document.querySelector("#cidade").innerHTML = ''
      cid_opts = document.createElement('option');
      cid_opts.setAttribute('value', '');
      cid_opts.innerHTML = "Cidade";
      document.querySelector("option#cidades").innerHTML = "Cidade";
      cid_opts.setAttribute('value', '');
      cid_opts.innerHTML = "Cidade";
  }
}